            ...
            <div class="projects-grid">
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>A full-featured online store with product filtering, cart functionality, and secure payment
                            processing.</p>
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>A productivity tool that helps teams organize tasks, set deadlines, and track project
                            progress.</p>
                        <div class="tech-stack">
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>A mobile-friendly application to track workouts, nutrition, and fitness goals with progress
                            charts.</p>
                        <div class="tech-stack">
            ...
            <div class="overlay-grid">
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>Comprehensive analytics dashboard for tracking social media engagement and performance
                            metrics.</p>
                        <div class="tech-stack">
                            <span class="tech-item">React</span>
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>Real-time financial dashboard for tracking investments, expenses, and market trends.</p>
                        <div class="tech-stack">
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80"
                            alt="Real Estate Platform">
                    </div>
                    <div class="project-content">
                        <h3>Real Estate Platform</h3>
                        <p>Property listing platform with advanced search, virtual tours, and agent management.</p>
                        <div class="tech-stack">
                            <span class="tech-item">Vue.js</span>
                            <span class="tech-item">Express</span>
                            <span class="tech-item">PostgreSQL</span>
                            <span class="tech-item">Mapbox</span>
                        </div>
                        <div class="project-links">
                            <a href="#"><i class="fas fa-external-link-alt"></i> Live Demo</a>
                            <a href="#"><i class="fab fa-github"></i> Source Code</a>
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="https://images.unsplash.com/photo-1559028012-481c04fa702d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1036&q=80"
                            alt="Travel Blog">
                    </div>
                    <div class="project-content">
                        <h3>Travel Blog Platform</h3>
                        <p>Interactive travel blog with location-based content, user submissions, and itinerary
                            planning.</p>
                        <div class="tech-stack">
                            <span class="tech-item">React</span>
                            <span class="tech-item">Node.js</span>
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>AI-powered recipe discovery platform with dietary filters and meal planning features.</p>
                        <div class="tech-stack">
                            <span class="tech-item">Next.js</span>
                            <span class="tech-item">Firebase</span>
                            <span class="tech-item">TensorFlow.js</span>
                            <span class="tech-item">Spoonacular API</span>
                        </div>
                        <div class="project-links">
                            <a href="#"><i class="fas fa-external-link-alt"></i> Live Demo</a>
                            <a href="#"><i class="fab fa-github"></i> Source Code</a>
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p>Interactive language learning platform with speech recognition and progress tracking.</p>
                        <div class="tech-stack">
                            <span class="tech-item">React Native</span>
                            <span class="tech-item">Redux</span>
                            <span class="tech-item">Node.js</span>
